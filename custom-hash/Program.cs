    ...
    public static void Main(string[] args)
    {
        ...
        try
        {
            ...
            if (args[0] == "--help" || args[0] == "-h" || args[0] == "/?")
            {
                ...
                Console.WriteLine("  hashv0.1  - Custom Hash version 0.1");
                Console.WriteLine("  hashv0.2  - Custom Hash version 0.2");
                Console.WriteLine("  hashv0.3  - Custom Hash version 0.3");
                Console.WriteLine("  hashv1.0  - Custom Hash version 1.0");
                Console.WriteLine("  hashv1.1  - Custom Hash version 1.1");
